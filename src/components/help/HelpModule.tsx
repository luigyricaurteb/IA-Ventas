...
const INSTALL_SECTIONS: InstallSection[] = [
  ...
  {
    id: "onboarding", icon: "🏢", title: "Checklist: Nueva empresa afiliada", tag: "Plataforma Master",
    steps: [
      { title: "Paso 1 — Crear la empresa en el sistema",
        text: "Plataforma → 🏢 Empresas → + Nueva empresa\n• Nombre, slug (ej: restaurante-mario), NIT, email, teléfono\n• Plan asignado\n• Usuario admin: username, nombre, contraseña temporal\n→ La empresa queda activa inmediatamente." },
      { title: "Paso 2 — Configurar WhatsApp de la empresa",
        text: "La empresa debe:\n1. Crear App en developers.facebook.com (ver sección WhatsApp Cloud API)\n2. Agregar producto WhatsApp\n3. Generar token permanente con usuario del sistema\n4. Configurar webhook: https://tu-dominio.railway.app/api/whatsapp/webhook\n5. Pegar credenciales en Ajustes → ☁️ Meta/WhatsApp\n\nAivox le puede hacer esto por ellos como servicio de onboarding." },
      { title: "Paso 3 — Configurar el negocio",
        text: "La empresa completa en sus Ajustes:\n• Empresa: nombre, logo, horarios de atención, email de alertas\n• Cuentas bancarias: datos reales para que Julieta los use al cotizar\n• Julieta IA: instrucciones generales, personalidad, tono\n• Productos/servicios: catálogo con precios y fotos" },
      { title: "Paso 4 — Activar extensiones (si aplica)",
        text: "Desde Plataforma → Empresas → la empresa → Extensiones:\n• 🤖 Autopilot: publicar en redes sociales con IA\n• 🎤 Audio IA: transcripción de mensajes de voz\n• 🔧 Modo Admin WhatsApp: el dueño consulta datos desde su WhatsApp\n\nCada extensión tiene un costo adicional mensual definido en el plan.",
        tip: "Activa las extensiones ANTES de que el cliente empiece a usarlas." },
      { title: "Paso 5 — Definir modelo de costos",
        text: "Plataforma → Empresas → la empresa → Modelo de costos:\n• 'Aivox absorbe': Aivox paga el consumo extra (recomendado en lanzamiento)\n• 'Empresa paga': la empresa recibe alertas cuando supera límites del plan\n\nRegla general: clientes nuevos en modo 'Aivox absorbe' hasta que estabilicen su uso." },
      { title: "Paso 6 — Entregar acceso al cliente",
        text: "Compartir con el cliente:\n• URL del sistema: tu-dominio.railway.app\n• Empresa (slug): el slug que creaste\n• Usuario: el admin que creaste\n• Contraseña temporal (pedirle que la cambie en su primer acceso)\n\nDocumentar en una ficha de cliente: fecha de inicio, plan, extensiones, modelo de costos." },
    ],
  },
  {
    id: "costos", icon: "💰", title: "Costos de la plataforma", tag: "Referencia Aivox",
    steps: [
      { title: "Costos fijos de Aivox (tú los pagas siempre)",
        text: "• Railway (hosting): ~$20-30 USD/mes → railway.app\n• Dominio aivoxgroup.com: ~$12-15 USD/año → godaddy.com\n\nTotal fijo: ~$21-31 USD/mes (~$85.000-125.000 COP)\nRentable desde el primer cliente que pague más de $31 USD/mes." },
      { title: "Servicios gratuitos que usamos",
        text: "• Meta WhatsApp Cloud API (primeras 1.000 conv/mes) → developers.facebook.com\n• OpenRouter IA gpt-4o-mini (free tier) → openrouter.ai\n• Google Sheets API → console.cloud.google.com\n• HuggingFace (modelo Whisper, descarga única) → huggingface.co\n• Resend email (3.000/mes gratis) → resend.com\n• Meta Facebook/Instagram Autopilot → developers.facebook.com" },
      { title: "Costos variables por empresa (cuando escala)",
        text: "• WhatsApp mensajes: $0.015 USD por conversación sobre 1.000/mes → developers.facebook.com/docs/whatsapp/pricing\n• OpenRouter IA: $0.15 USD por millón de tokens (si cambias de free) → openrouter.ai/docs\n• Railway extra RAM/CPU: según uso → railway.app/pricing\n\nEstos costos se activan cuando una empresa tiene alto volumen.",
        warning: "Sin control, una empresa muy activa puede generar costos que superan lo que paga. Monitorea el uso en Plataforma → 📊 Métricas." },
      { title: "Modelo de costos recomendado por etapa",
        text: "🟢 Lanzamiento (primeros 6 meses): Aivox absorbe todo → consigues casos de éxito\n🟡 Crecimiento (6-12 meses): Empresas de alto volumen pagan consumo extra\n🔴 Escala (+12 meses): Todas las empresas pagan su consumo real\n\nCambia el modelo por empresa desde Plataforma → Empresas → Modelo de costos." },
    ],
  },
];
